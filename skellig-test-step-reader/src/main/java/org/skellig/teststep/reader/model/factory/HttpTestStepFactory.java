...
public class HttpTestStepFactory extends BaseTestStepFactory {
    ...
    private static final String METHOD_KEYWORD = "http_method";
    private static final String HEADERS_KEYWORD = "http_headers";
    private static final String QUERY_KEYWORD = "http_query";
    private static final String FORM_KEYWORD = "form";
    private static final String USER_KEYWORD = "username";
