...
class TestDataFromCsvConverterTest {
    ...
    fun testConvertFromCsvFile() {
        val result = testDataFromCsvConverter!!.execute("fromCsv", arrayOf("csv/test-file.csv"))
    ...
    fun testConvertFromCsvFileWithFiltering() {
        ...
        val result = testDataFromCsvConverter!!.execute(
            "fromCsv",
    ...
    fun testConvertWhenFileNotExist() {
        Assertions.assertThrows(TestDataConversionException::class.java) {
            testDataFromCsvConverter!!.execute("fromCsv", arrayOf("csv/missing.csv"))
        }
    }
}