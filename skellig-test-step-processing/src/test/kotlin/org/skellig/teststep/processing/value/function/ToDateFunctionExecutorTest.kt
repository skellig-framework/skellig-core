...
class ToDateFunctionExecutorTest {
    ...
    fun testConvertToDateWithInvalidFormat() {
        val ex = assertThrows(FunctionValueExecutionException::class.java) { converter.execute("toDate", arrayOf("77-77-2001")) }
    ...
    fun testConvertToDateWithInvalidNumberOfArguments() {
        val ex = assertThrows(FunctionValueExecutionException::class.java) { converter.execute("toDate", arrayOf("01-01-2001", "UTC")) }
